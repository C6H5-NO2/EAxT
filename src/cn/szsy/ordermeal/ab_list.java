...
public class ab_list extends Activity
{
	@Override
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		//ordered.setClickable(false);	//modify
	...
	class Adpa extends BaseAdapter
	{
		...
		public View getView(int position, View convert, ViewGroup parent)
		{
			...
			if (convert == null)
			{
				...
				convert = LayoutInflater.from(context).inflate(R.layout.listitem_ab, null);
	...
	public boolean onKeyDown(int keyCode, KeyEvent event)
	{
		if (keyCode == KeyEvent.KEYCODE_BACK)
		{
			...
			{
				Toast.makeText(this, "订单尚未提交，返回无法保存", Toast.LENGTH_SHORT).show();
