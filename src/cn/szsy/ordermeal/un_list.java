...
public class un_list extends Activity
{
	@Override
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		SimpleAdapter sap = new SimpleAdapter(this, ol, R.layout.listitem_un, new String[] { "bh","lb","cm","dj","dg"}, new int[] {R.id.bh, R.id.lb,R.id.cm,R.id.dj,R.id.fs});
		list.setAdapter(sap);
	}
