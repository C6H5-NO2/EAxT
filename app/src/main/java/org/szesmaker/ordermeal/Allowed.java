...
public class Allowed extends TabActivity
{
    ...
    private void getOverflowMenu()
    {
        ...
        {
            Toast.makeText(Allowed.this, "不支持该版本", Toast.LENGTH_SHORT).show();
            finish();
        }
    }
    class ordermeal extends AsyncTask<Void, Void, Void>
    {
        ...
        protected void onPostExecute(Void result)
        {
            ...
            if (dd)
            {
                Toast.makeText(Allowed.this, "提交成功", Toast.LENGTH_SHORT).show();
                editor.clear();
                editor.commit();
                Allowed.this.finish();
            }
            else
                Toast.makeText(Allowed.this, "提交失败", Toast.LENGTH_SHORT).show();
        }
    }
